<template>
  <div class="main">
    <div class="contact-section">
      <div class="left">
        <h1>Je suis juste <span>ici</span> !</h1>
        <svg
        ...
        >
          ...
          <g fill="#111111" stroke="#fff" stroke-width="2">
            <path
              id="dep_13"
          ...
          <text class="city-text" x="41%" y="50%">NANTES</text>
        </svg>
      </div>

      <div class="right">
        <h1>Contactez-moi ✍️</h1>
        <p>N'hésitez pas à me contacter par mail :</p>
        <a href="mailto:florstheo@gmail.com"
          ><span>✉️ florstheo@gmail.com</span></a
        >
        <p>ou par téléphone au :</p>
        <a href="tel:0782832611"><span>📱 07 82 83 26 11</span></a>
        <h2>Besoin d'en savoir plus ?</h2>
        <a
          target="_blank"
          href="https://backend.theo-flores.fr/wp-content/uploads/2022/05/CV_Theo_Flores.pdf"
        >
          <span>📝 Télécharger mon CV</span></a
        >
      </div>
    </div>
  </div>
  ...
  .left {
    ...
    svg {
      ...
      g {
        ...
        animation: dash 12s linear reverse;
